...
![[exemplo-jsx]](../photos/conceitos-react/exemplo-jsx.png)
...
![[problema-repetir-codigo]](../photos/conceitos-react/problema-repetir-codigo.png)

Resposta: Componentizar tanto a estilização quanto a estrutura, tornando o código mais legível e funcional.

![[resposta-repetir-codigo]](../photos/conceitos-react/resposta-repetir-codigo.png)

2. Conceito: **PROPS**

Problema: Porém há uma necessidade de passar um **children independente**, pra cada um dos componentes, vem o segundo conceito.

![[problema-children-independente]](../photos/conceitos-react/problema-children-independente.png)

**Props** são os **parâmetros** da nossa função. 

Resposta: No exemplo, **{ children }** é passado a como parâmetro de Button.

E no **return**, ele é acessado através das **chaves { }**, que é a forma de passar uma variável javascript para dentro de um HTML.

![[resposta-children-independente]](../photos/conceitos-react/resposta-children-independente.png)
...
![[resposta-informacao-do-usuario.png]](../photos/conceitos-react/resposta-informacao-do-usuario.png)

2. Usando o evento onChange, que no React, detecta quando o valor de um elemento de entrada muda.

![[resposta-recuperar-informacoes-do-usuario.png]](../photos/conceitos-react/resposta-recuperar-informacoes-do-usuario.png)

3. Usando o React Hook, **useState**. Pois é ele quem **gerencia os states (estados)** do componente.

![[resposta-salvar-e-atualizar-informacoes-do-usuario.png]](../photos/conceitos-react/resposta-salvar-e-atualizar-informacoes-do-usuario.png)
